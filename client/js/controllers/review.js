...
angular
  ...
  .controller('AddCoffeeshopController', ['$scope', 'CoffeeShop',
      '$state', function($scope, CoffeeShop, $state) {
    $scope.action = 'Add';
    $scope.selectedShop;
    $scope.isDisabled = false;
    $scope.cities = ["new york","chicago","whashington","boston","san francisco","los angeles","atlanta"];

    $scope.submitForm = function() {
      CoffeeShop
        .create({
          name: $scope.coffeeshop.name,
